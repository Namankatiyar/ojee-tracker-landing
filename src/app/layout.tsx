...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-screen flex flex-col bg-black text-white selection:bg-azure selection:text-white font-sans overflow-x-hidden">
          ...
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden h-9 items-center gap-2 rounded bg-white/5 px-4 text-sm font-medium transition-colors hover:bg-white/10 sm:flex"
              >
                <svg
                  className="h-5 w-5 fill-current"
                  viewBox="0 0 24 24"
